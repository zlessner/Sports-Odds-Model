                ...
                if (HomeAlphaOdds>7):
                    for n in range(len(discrepancy)):
                        if discrepancy[n].rsplit(' ', 1)[0] == AlphaAPI[i]:
                            print(discrepancy[n])
                    if round((107/midDayWinProb[j])-100) >= .95*int(((Away[i])-1)*100):
                ...
                if (AwayBetaOdds>7):
                    for n in range(len(discrepancy)):
                        if discrepancy[n].rsplit(' ', 1)[0] == BetaAPI[i]:
                            print(discrepancy[n])
                    if round((107/midDayLoseProb[j])-100) >= .95*int(((Home[i])-1)*100):
            ...
            if (AlphaAPI[i]).lower() == (midDayLoseTeam[j].lower()):
                ...
                if (AwayAlphaOdds>7):
                    for n in range(len(discrepancy)):
                        if discrepancy[n].rsplit(' ', 1)[0] == AlphaAPI[i]:
                            print(discrepancy[n])
                    if round((107/midDayLoseProb[j])-100) >= .95*int(((Away[i])-1)*100):
                        break_point.append(round((107/midDayLoseProb[j])-100))
                    else:
                        break_point.append(round(.95*int(((Away[i])-1)*100)))
            ...
            if (BetaAPI[i]).lower() == (midDayWinTeam[j].lower()):
                ...
                if (HomeBetaOdds>7):
                    for n in range(len(discrepancy)):
                        if discrepancy[n].rsplit(' ', 1)[0] == BetaAPI[i]:
                            print(discrepancy[n])
                    if round((107/midDayWinProb[j])-100) >= .95*int(((Home[i])-1)*100):
                        break_point.append(round((107/midDayWinProb[j])-100))
                    else:
                        break_point.append(round(.95*int(((Home[i])-1)*100)))
