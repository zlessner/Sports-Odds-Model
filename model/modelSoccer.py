...
# Championship
    ...
    # Italy Serie A -- CHECK BACK FOR INTER MILAN NEXT WEEK
    if teams[i] == "AC Milan":
        team_num_t.append(5)
    if teams[i] == "Atalanta":
    ...
    if teams[i] == "Verona":
     ...
     # Italy Serie B - change names and unccoment once rest of teams are filled in
    # if teams[i] == "Brescia":
